...
def defence(char_name: str, char_class: str) -> str:
    """Вычисляет сколько урона было блокировано."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выводит какое специальное умение было использовано."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция для запуска старта игры."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция для выбора персонажа игры."""
    approve_choice: str = ''
    char_class: str = ''
